      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ImportExportButtons
            ...
            exportEndpoint="/import-export/purchases/export"
            importEndpoint="/import-export/purchases/import"
            onImportSuccess={() => fetchPurchases()}
            sampleFields={['po_date', 'supplier_name', 'remarks', 'item_description', 'qty', 'price']}
          />
          <button
