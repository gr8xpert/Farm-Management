      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ImportExportButtons
            ...
            exportEndpoint="/import-export/customers/export"
            importEndpoint="/import-export/customers/import"
            onImportSuccess={() => fetchCustomers()}
            sampleFields={['customer_name', 'contact_person', 'phone_number', 'email_address', 'country', 'state', 'city', 'address']}
          />
          <button
