    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ImportExportButtons
            entityName="Payments"
            exportEndpoint="/import-export/payments/export"
            importEndpoint="/import-export/payments/import"
            onImportSuccess={() => fetchPayments()}
            sampleFields={['payment_date', 'payment_type', 'payment_amount', 'payment_mode', 'bank_name', 'supplier_name', 'customer_name', 'employee_name', 'remarks']}
          />
          <button
      ...
      >
        <div className="space-y-4">
          ...
          <div className={formData.payment_type === 'SALARY' ? 'form-grid-3' : 'form-grid-4'}>
            <div>
